...
public class ParcelaFaturaTestes {
    ...
    public void deveriaRetornarCreatedAoParcelarFatura() throws JSONException {
        ...
        given()
                .basePath("/api/faturas/parcelas/" + numeroCartaoExistente + "/" + identificadorFatura)
    ...
    @Test
    public void deveriaRetornarNotFoundAoTentarParcelarFaturaNaoExistente() throws JSONException {
