...
public class ConsultaSaldoTestes {

    @LocalServerPort
    private int port;

    @Test
    public void deveRetornarOkAoConsultarSaldo() throws JSONException {
    ...
    @Test
    public void deveRetornarNotFoundAoConsultarSaldoDeCartaoNaoExistente() throws JSONException {
